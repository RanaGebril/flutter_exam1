        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding:
                    const EdgeInsets.only(top: 16,bottom: 25),
                child: ButtonsTabBar(
                  width: 100,
              ...
              Expanded(
                child: Padding(
                  ...
                  child: ListView(
                    ...
                    children: [
                      Image.asset("assets/screen1/images/postter1.png", width: 200,height: 30,),
                      SizedBox(
                        width: 0,
                      ),
                      Image.asset("assets/screen1/images/postter2.png",width: 200,height: 300,)
                    ],
                  ),
                ),
              ),
